...
export default function JusticeRightsChat() {
    ...
    const [messages, setMessages] = useState([
        { id: '1', text: `Hello! I am your ${name || 'Fundamental Rights'} legal guide. What legal or institutional rights would you like clarification on today?`, sender: 'other' },
    ]);
        ...
        <View style={[styles.container, { backgroundColor: theme.background }]}>
            ...
            <View style={[styles.header, { paddingTop: insets.top + 12, borderBottomColor: theme.border, backgroundColor: isDark ? 'rgba(7, 6, 20, 0.75)' : 'rgba(255, 255, 255, 0.85)' }]}>
                ...
                <View style={styles.headerInfo}>
                    <Text style={[styles.title, { color: theme.text }]} numberOfLines={1}>{name || 'Legal Rights Guide'}</Text>
                    <View style={styles.onlineStatus}>
                        <View style={styles.onlineDot} />
                        <Text style={[styles.statusText, { color: isDark ? '#A09CB8' : '#716F8E' }]}>Rights & Legal Advocacy</Text>
                    </View>
                </View>
