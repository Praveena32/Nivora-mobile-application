...
export default function JusticeProtectionChat() {
    ...
    const [messages, setMessages] = useState([
        { id: '1', text: `Hello! I am your ${name || 'Emergency Protection'} coordinator. Your physical and psychological safety is our top priority. How can we protect you right now?`, sender: 'other' },
    ]);
        ...
        <View style={[styles.container, { backgroundColor: theme.background }]}>
            ...
            <View style={[styles.header, { paddingTop: insets.top + 12, borderBottomColor: theme.border, backgroundColor: isDark ? 'rgba(7, 6, 20, 0.75)' : 'rgba(255, 255, 255, 0.85)' }]}>
                ...
                <View style={styles.headerInfo}>
                    <Text style={[styles.title, { color: theme.text }]} numberOfLines={1}>{name || 'Protection Officer'}</Text>
                    <View style={styles.onlineStatus}>
                        <View style={styles.onlineDot} />
                        <Text style={[styles.statusText, { color: isDark ? '#A09CB8' : '#716F8E' }]}>Emergency Protection Unit</Text>
                    </View>
                </View>
