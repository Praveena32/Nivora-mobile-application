...
export default function JusticeDirectoryChat() {
    ...
    const [messages, setMessages] = useState([
        { id: '1', text: `Hello! I am your ${name || 'Support Services'} coordinator. How can I help connect you with verified hotlines and legal support organizations today?`, sender: 'other' },
    ]);
        ...
        <View style={[styles.container, { backgroundColor: theme.background }]}>
            ...
            <View style={[styles.header, { paddingTop: insets.top + 12, borderBottomColor: theme.border, backgroundColor: isDark ? 'rgba(7, 6, 20, 0.75)' : 'rgba(255, 255, 255, 0.85)' }]}>
                ...
                <View style={styles.headerInfo}>
                    <Text style={[styles.title, { color: theme.text }]} numberOfLines={1}>{name || 'Service Liaison'}</Text>
                    <View style={styles.onlineStatus}>
                        <View style={styles.onlineDot} />
                        <Text style={[styles.statusText, { color: isDark ? '#A09CB8' : '#716F8E' }]}>Directory Coordinator</Text>
                    </View>
                </View>
