                    ...
                    renderItem={({ item }) => (
                        <TouchableOpacity
                            style={[
                                ...
                                activeCategory === item && [styles.activeFilterChip, { backgroundColor: theme.primary, borderColor: theme.primary }]
                            ]}
                        ...
                        >
                            <Text style={[
                                ...
                                activeCategory === item && [styles.activeFilterText, { color: isDark ? '#000' : '#FFF' }]
            ...
            <FlatList
                ...
                renderItem={({ item }) => (
                    <View style={[
                        ...
                        !item.isRead && [styles.unreadCard, { borderColor: theme.primary }]
                    ]}>
                        <View style={[styles.iconBox, { backgroundColor: getCategoryColor(item.category) + (isDark ? '25' : '15') }]}>
                        ...
                        <View style={styles.alertContent}>
                            ...
                            <Text style={[styles.alertDescription, { color: theme.textSecondary }]}>{t(item.descriptionKey)}</Text>
                        </View>
                ...
                ListEmptyComponent={
                    <View style={styles.emptyContainer}>
                        ...
                        <Text style={[styles.emptySub, { color: theme.textSecondary }]}>{t('noNewNotifications')}</Text>
                    </View>
                }
            />
        </View>
