            ...
            <View style={[styles.header, { paddingTop: insets.top + 20 }]}>
                <View style={styles.headerTop}>
                    <View>
                        ...
                        <Text style={[styles.subtitle, { color: theme.primary }]}>{t('helpTapAway')}</Text>
                    </View>
                    <TouchableOpacity
                        style={[styles.closeButton, { backgroundColor: theme.surface, borderColor: theme.border, borderWidth: 1 }]}
                        onPress={() => {
                            if (!isLoggedIn) {
                    ...
                    >
                        ...
                        <Text style={[styles.closeText, { color: theme.primary }]}>{(!isLoggedIn || !isUnlocked) ? t('home') : t('done')}</Text>
                    </TouchableOpacity>
                </View>
            </View>
            ...
            <FlatList
                ...
                renderItem={({ item }) => (
                    <TouchableOpacity
                        ...
                        activeOpacity={0.7}
                    >
                        <View style={[styles.iconBox, { backgroundColor: item.color + (isDark ? '20' : '15') }]}>
