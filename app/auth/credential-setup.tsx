                ...
                >
                    ...
                    {step === 1 && (
                        <View style={styles.stepContainer}>
                            <Text style={[styles.label, { color: theme.text }]}>Identify Recovery Image</Text>
                                ...
                                {SECURITY_IMAGES.map(img => (
                                    <TouchableOpacity
                                        ...
                                        style={[
                                            ...
                                            verifyImage === img.id && [styles.imageItemActive, { borderColor: theme.primary, backgroundColor: isDark ? 'rgba(176,164,241,0.15)' : 'rgba(120,104,230,0.15)' }]
                                        ]}
                                        onPress={() => setVerifyImage(img.id)}
                                    >
                                        <Text style={[styles.imageEmoji, { fontSize: 50, marginBottom: 0 }]}>{img.emoji}</Text>
                                        <Text style={[styles.imageLabel, { fontSize: 11, color: theme.text }]}>{img.label}</Text>
                                    </TouchableOpacity>
                                ))}
                            </View>

                            <View style={[styles.inputGroup, { marginBottom: 15 }]}>
                                <Text style={[styles.miniLabel, { color: theme.textSecondary }]}>Security Question: {currentSecQuiz?.question}</Text>
                                <View style={[styles.compactWrapper, { backgroundColor: theme.inputBackground, borderColor: theme.border }]}>
                                    <Ionicons name="help-circle-outline" size={18} color={theme.placeholder} style={styles.prefixIcon} />
                                    <TextInput
                            ...
                            <TouchableOpacity style={[styles.nextButton, { backgroundColor: theme.primary, height: 44, marginTop: 4 }]} onPress={nextStep}>
                                <Text style={[styles.nextButtonText, { color: isDark ? '#000' : '#FFF' }]}>Verify & Proceed</Text>
                            </TouchableOpacity>
                        </View>
                    )}
                    ...
                    {step === 2 && (
                        <View style={styles.stepContainer}>
                            <View style={styles.inputGroup}>
                                <Text style={[styles.miniLabel, { color: theme.textSecondary }]}>New Password</Text>
                                <View style={[styles.compactWrapper, { backgroundColor: theme.inputBackground, borderColor: theme.border }]}>
                            ...
                            <View style={styles.inputGroup}>
                                <Text style={[styles.miniLabel, { color: theme.textSecondary }]}>Confirm New Password</Text>
                                <View style={[styles.compactWrapper, { backgroundColor: theme.inputBackground, borderColor: theme.border }]}>
                                    <Ionicons name="shield-checkmark-outline" size={18} color={theme.placeholder} style={styles.prefixIcon} />
                                    <TextInput
                                        style={[styles.compactInput, { color: theme.text }]}
                                        placeholder="••••••••"
                                        placeholderTextColor={theme.placeholder}
                            ...
                            <View style={styles.buttonRow}>
                                <TouchableOpacity style={[styles.prevButton, { backgroundColor: theme.surfaceSecondary, borderColor: theme.border }]} onPress={prevStep}>
                                    <Text style={[styles.prevButtonText, { color: theme.text }]}>Back</Text>
                                </TouchableOpacity>
                                <TouchableOpacity style={[styles.nextButton, styles.halfButton, { backgroundColor: theme.primary }]} onPress={nextStep}>
                                    <Text style={[styles.nextButtonText, { color: isDark ? '#000' : '#FFF' }]}>Continue</Text>
                                </TouchableOpacity>
                            </View>
                        </View>
                    )}
                    ...
                    {step === 3 && (
                        <View style={styles.stepContainer}>
                            <Text style={[styles.label, { color: theme.text }]}>Update Safety PIN</Text>
                            <TouchableOpacity
                            ...
                            <Text style={[styles.label, { color: theme.text, marginTop: 20 }]}>New Security Image</Text>
                            <View style={styles.imageGrid}>
                                {SECURITY_IMAGES.map(img => (
                                    ...
                                    >
                                        ...
                                        <Text style={[styles.imageLabel, { color: theme.text }]}>{img.label}</Text>
                                    </TouchableOpacity>
                                ))}
                            </View>
                    ...
                    {step === 4 && (
                        <View style={styles.stepContainer}>
                            <Text style={[styles.label, { color: theme.text }]}>New Security Quiz</Text>
                            <View style={styles.inputGroup}>
                                <Text style={[styles.miniLabel, { color: theme.textSecondary }]}>Recovery Question</Text>
                                <View style={[styles.compactWrapper, { backgroundColor: theme.inputBackground, borderColor: theme.border }]}>
                                    <TextInput
                                        style={[styles.compactInput, { color: theme.text }]}
                            ...
                            <View style={styles.inputGroup}>
                                <Text style={[styles.miniLabel, { color: theme.textSecondary }]}>Answer</Text>
                                <View style={[styles.compactWrapper, { backgroundColor: theme.inputBackground, borderColor: theme.border }]}>
                                    <TextInput
                                        style={[styles.compactInput, { color: theme.text }]}
                            ...
                            <View style={styles.buttonRow}>
                                ...
                                <TouchableOpacity style={[styles.signupButton, { backgroundColor: theme.primary }]} onPress={handleUpdate}>
                                    <Text style={[styles.signupButtonText, { color: isDark ? '#000' : '#FFF' }]}>Update All</Text>
                                </TouchableOpacity>
                            </View>
                        </View>
                    )}
